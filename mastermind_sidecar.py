"""
Mastermind Sidecar — spacex-launch-sequencer
...
class MastermindSidecar:
    ...
    def __init__(self, repo_name: str = "spacex-launch-sequencer"):
        self.repo_name = repo_name
        self.start_time = time.time()
        self.health_cache: Dict[str, Any] = {}
        self._modules = [countdown, abort_controller, probabilistic_abort]
